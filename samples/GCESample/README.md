...
- /compute/list - GET call for viewing created instances (needs query parameters)
- /compute/describe - GET call for viewing details of specific instance (needs query parameters)
- /compute/describe/[projectId]/[zone]/[instanceName] - GET call for viewing details of specific instance
- /compute/listAll - GET call for viewing details of all instances (needs query parameters)
- /compute/listAll/[projectId]/[zone] - GET call for viewing details of all instances in a zone
- /compute/listAll/[projectId]/ - - GET call for viewing details of all instances in all zones in a project
