...
The following commands will build and deploy the application...
    ...
    % docker images gcr.io/investdemo-300915/demoapp
    REPOSITORY                               TAG       IMAGE ID       CREATED        SIZE
    gcr.io/investdemo-300915/demoapp   latest    1ae6f324852b   51 years ago   148MB
...
You can also build this sample using Docker. To do this, run the following...
    ...
    % docker build . \
        ...
        [-t gcr.io/$(gcloud config get-value project)/demoapp:1.0]
...
below...
    ...
    % docker run -p 8080:8080 gcr.io/$(gcloud config get-value project)/demoapp:1.0
      .   ____          _            __ _ _
...
To deploy the app to CloudRun, you can do...
    ...
    % gcloud run deploy --image gcr.io/$(gcloud config get-value project)/demoapp --platform managed
    Deploying container to Cloud Run service [demoapp] in project [investdemo-300915] region [europe-west1]
    ... 
    Service [demoapp] revision [demoapp-00001-roj] has been deployed and is serving 100 percent of traffic.
    Service URL: https://demoapp-r2aphpfqba-ew.a.run.app
    % gcloud run services list --platform managed
    % curl https://demoapp-r2aphpfqba-ew.a.run.app/cmd/version
    <h2>Version 1.0</h2>
...
To clean up the app, you can do...
    ...
    # The delete statement below uses "demoapp" as the name...
    % gcloud run services delete demoapp --platform managed
    % docker image rm -f gcr.io/$(gcloud config get-value project)/demoapp 
